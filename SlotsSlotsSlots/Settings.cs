...
namespace SlotsSlotsSlots
{
    ...
    {   
        ...
        [SynthesisTooltip("A value of 0.2 would mean the effect has 20% effectiveness.")]
        ...
        [SynthesisTooltip("A value of 0.1 makes it, so 10 potions are needed to fill 1 slot.")]
